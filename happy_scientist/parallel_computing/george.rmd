---
title: 'The Happy Scientist Semminar<br>A brief introduction to using R for high-performance computing'
author: 'George Vega Yon<br>Garret Weaver'
output: 
  slidy_presentation:
    theme: journal
    highlight: haddock
    duration: 45
date: 'Department of Preventive Medicine<br>March 23, 2017'
---
...
we'll focus on the following R-packages/tools
...
For more, checkout the [CRAN Task View](https://cran.r-project.org/web/views/HighPerformanceComputing.html)
