...
| [**MethCon5**](https://github.com/USCbiostats/MethCon5) | R package to identify and rank CpG DNA methylation conservation along the human genome [![CRAN status](https://www.r-pkg.org/badges/version/MethCon5)](https://CRAN.R-project.org/package=methcon5) [![CRAN downloads](http://cranlogs.r-pkg.org/badges/grand-total/MethCon5)](https://cranlogs.r-pkg.org/badges/grand-total/methcon5) [![status](https://tinyverse.netlify.com/badge/Methcon5)](https://CRAN.R-project.org/package=methcon5)         |
