...
*   We won't discuss either Rcpp or coding R itself. (for that I
    recommend ["Advance R"](http://adv-r.had.co.nz/Rcpp.html))
...
Once you have run R CMD checks and no erros or unexpected issues are detected,
...
*   The devtools package was built to make life easier. Such is it's creator's
    confidance on the `release` function that it comes with a warranty!
